            ...
            <div class="navbar navbar-fixed-top  navbar-inverse noprint" style="min-width:1050px">
                ...
                <script type="text/javascript">
                    ...
                    $(document).ready(function ()
                    {
                                  ...
                                  switch(data.result_type){
                                     ...
                                     case 'Select':
                                        ...
                                        editor.jqxDropDownList(
                                            {
                                                source: listdataAdapter.records, displayMember: "id",autoDropDownHeight: true, valueMember: "leadid",promptText:"No Leads",renderer: function (index, label, value) 
                                                    {
                                                    //alert("value "+value);
                               ...
                               resultsEditorat: function(row, cellvalue, editor){
                                 ...
                                 //  var data.leadid = $('#jqxgrid_add').jqxGrid('getrowdata', row);
                                  ...
                                  switch(data.result_type){
                                     ...
                                     break;
                                     case 'Select':
                                         editor.jqxDropDownList({source: ["LEADS"],autoDropDownHeight: true});
                                 }           
                               },
                                                ...
                                                $("#jqxgrid_n").jqxGrid(
                                                        {
                                                            ...
                                                            columns: [
                                                                ...
                                                                {text: 'Lead id', datafield: 'leadid', displayfield: 'leadid', width: 75, cellsalign: 'center', cellbeginedit: Resultsupdate.initResultsEditor, initeditor: Resultsupdate.resultsEditor, cellsrenderer: Resultsupdate.renderUnits,cellvaluechanging: function (row, datafield, columntype, oldvalue, newvalue) 
                                                                        {
                                                                ...
                                                                {text: 'Required Quantity', datafield: 'quantity', width: 75, cellsalign: 'left',
                                                                    ...
                                                                    {text: 'Sales Type', datafield: 'division', width: 110, cellsalign: 'left',cellbeginedit:Resultsupdate.initResultsEditorst, initeditor: Resultsupdate.resultsEditorst, cellsrenderer: Resultsupdate.renderUnitsst
                        ...
                        $("#jqxgrid_add").jqxGrid(
                                {
                                    ...
                                    columns: [
                                        ...
                                        {text: 'Product Group', datafield: 'itemgroup', width: 150, cellsalign: 'left', editable: false},   
                                        {text: 'Lead id', datafield: 'leadid', displayfield: 'leadid', width: 75, cellsalign: 'center', cellbeginedit:Results.initResultsEditor, initeditor: Results.resultsEditor, cellsrenderer: Results.renderUnits,
                                        ...
                                        {text: 'Sales Type', datafield: 'division', width: 110, cellsalign: 'left',cellbeginedit:Results.initResultsEditorst, initeditor: Results.resultsEditorst, cellsrenderer: Results.renderUnitsst
                                        /*,cellvaluechanging: function (row, datafield, columntype, oldvalue, newvalue) 
                                                        {
                                                           // alert("oldvalue "+oldvalue); alert("newvalue "+newvalue);
                                                              alert("row "+row);
                        ...
                        $("#addcurrentdate").jqxDateTimeInput({width: '250px', height: '25px', theme: 'summer', formatString: 'dd/MM/yyyy',maxDate: new Date()});
