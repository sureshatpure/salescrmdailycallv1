                ...
                <script type="text/javascript">
                    ...
                    $(document).ready(function ()
                    {
                        ...
                        $("#jqxgrid").jqxGrid(
                                ...
                                /*$("#jqxgrid_n").bind('cellbeginedit', function (event) {
                                   var column = args.datafield;
                                   var row = args.rowindex;
                                   var value = args.value;
                                   // condition follows
                                 //  alert(" in cellbeginedit functon "+column);
                                 //  alert("column "+column);
                                 //  alert("row "+row);
                                 //  alert("value "+value);
                                   var rowdata = $("#jqxgrid_n").jqxGrid('getrowdata', row);
                                 ...
                                 //  alert("leadid "+leadid);
                                    if(args.datafield=='quantity' && leadid==0 )
                                    {
                                         alert("in function cellbeginedit");
                                         alert("column "+column);
                                         alert("row "+row);
                                       // $("#jqxgrid_n").jqxGrid('endcelledit', row, column, false);
                                    }

                               //   if (value<5) {
                                  //      $("#jqxgrid_n").jqxGrid('endcelledit', row, column, true);
                                 //  }
                                });*/
                        ...
                        $("#jqxgrid_add").jqxGrid(
                                {
                                    ...
                                    columns: [
                                        ...
                                        {text: 'lmsupdate', editable:false, cellsalign: 'center', datafield: 'lmsupdate', filterable: false, width: 100, cellsrenderer: function (row, columnfield, value, defaulthtml, columnproperties) { 
