            ...
            <div class="navbar navbar-fixed-top  navbar-inverse noprint" style="min-width:1050px">
                ...
                <script type="text/javascript">
                    ...
                    $(document).ready(function ()
                    {
                               ...
                               resultsEditorat: function(row, cellvalue, editor){
                                 ...
                                 //  var data.leadid = $('#jqxgrid_add').jqxGrid('getrowdata', row);
                                  ...
                                  switch(data.result_type){
                                     ...
                                     break;
                                     case 'Select':
                                         editor.jqxDropDownList({source: ["LEADS"]});
                                 }           
                               },
                        ...
                        /* change column type dynamic start for update*/
                        var  Resultsupdate ={

                                     
                               initResultsEditor: function(row){
                                  var data = $('#jqxgrid_n').jqxGrid('getrowdata', row);
                                  if(data.result_type === 'Value') this.columntype = 'Cascaded';
                                  else if(data.result_type === 'Select') this.columntype = 'dropdownlist';
              /*                    else if(data.result_type === 'Select One') this.columntype = 'dropdownlist';
                        ...
                        /* change column type dynameic end update*/
                                                ...
                                                $("#jqxgrid_n").jqxGrid(
                                                        {
                                                            ...
                                                            columns: [
                                                                ...
                                                                {text: 'Lead id', datafield: 'leadid', displayfield: 'leadid', width: 100, cellsalign: 'center', cellbeginedit: Resultsupdate.initResultsEditor, createeditor: Resultsupdate.resultsEditor, cellsrenderer: Resultsupdate.renderUnits},
                                            

                                                                {text: 'noofleads', datafield: 'noofleads', width: 75, cellsalign: 'left', editable: false},
                                                                {text: 'result_type', datafield: 'result_type', width: 75, cellsalign: 'left', editable: false},
                                                                ...
                                                                {text: 'Required Quantity', datafield: 'quantity', width: 75, cellsalign: 'left', cellbeginedit: function (row, datafield, columntype) {
                                                                ...
                                                                {text: 'Visited Date', datafield: 'date', columntype: 'datetimeinput', width: 110, align: 'left', cellsformat: 'd', formatString: 'yyyy-MM-dd',
                                                                initeditor: function (row, cellvalue, editor) {
                                                                        var starDate = "2015-07-01";
                                                                        var endDate = "2015-08-18";

                                                                        editor.jqxDateTimeInput('setDate', new Date());
                                                                       // editor.jqxDateTimeInput('setRange', starDate, endDate);
                                                                      },
                                                                    validation: function (cell, value) {
                                                                        var year = value.getFullYear();
                                                                        //valueTue Jun 16 2015 00:00:00 GMT+0530 (IST)
                                                    
                                                                        value=convert(value);
                                                                      // alert("converted date format "+value);
                                                                        function convert(datepassed)
                                                                            {
                                                                                var date = new Date(datepassed), mnth = ("0" + (date.getMonth() + 1)).slice(-2), day = ("0" + date.getDate()).slice(-2);
                                                                       ...
                                                                       // alert("value "+value); //value 2015-08-17
                                                                        
                                                                        var todayDate = new Date();
                                                                            todayDate.toISOString().substring(0, 10); //todayDate 2015-08-18
                                                                            
                                                                         if (value > todayDate.toISOString().substring(0, 10)) {
                                                                              return { result: false, message: "Visit Date should be less than today's date" };
                                                                          }
                        ...
                        $("#jqxgrid_add").jqxGrid(
                                {
                                    ...
                                    columns: [
                                        ...
                                        {text: 'Product Group', datafield: 'itemgroup', width: 150, cellsalign: 'left', editable: false},   
                                        {text: 'Lead id', datafield: 'leadid', displayfield: 'leadid', width: 100, cellsalign: 'center', cellbeginedit:Results.initResultsEditor, createeditor: Results.resultsEditor, cellsrenderer: Results.renderUnits,/*cellendedit:function (row, datafield, columntype) {
                                                     var rowdata = $("#jqxgrid_add").jqxGrid('getrowdata', row);
                                                        var result_type = rowdata.result_type;
                                                        if(result_type=='Value')
                                                        {
                                                            $("#jqxgrid_add").jqxGrid('setcellvalue', row, 'leadid', "0");
                                        ...
                                        {text: 'noofleads', datafield: 'noofleads', width: 75, cellsalign: 'left', editable: false},
                                        {text: 'result_type', datafield: 'result_type', width: 75, cellsalign: 'left', editable: false},
                                        {text: 'Activity Type', datafield: 'Sub_Activity', width: 150, cellsalign: 'left', cellbeginedit:Results.initResultsEditorat, createeditor: Results.resultsEditorat, cellsrenderer: Results.renderUnitsat,
                                        },
                                        ...
                                        {text: 'Sales Type', datafield: 'division', width: 150, cellsalign: 'left',cellbeginedit:Results.initResultsEditorst, createeditor: Results.resultsEditorst, cellsrenderer: Results.renderUnitsst
                                        /*,cellvaluechanging: function (row, datafield, columntype, oldvalue, newvalue) 
                                                        {
                                                           // alert("oldvalue "+oldvalue); alert("newvalue "+newvalue);
                                                              alert("row "+row);
                        ...
                        $("#jqxgrid_n").on('cellendedit', function (event,value) 
                            {
                                ...
                                {
                                    alert("in update cellendedit subactivity");
                                }
                        ...
                        $("#jqxgrid_add").on('cellendedit', function (event,value) 
                            {
                                ...
                                if(args.datafield=='subactivity')
                                {
                                    alert("in cellendedit add mode subactivity");
                                }
                            });
