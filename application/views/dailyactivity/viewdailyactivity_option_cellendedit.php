                                        ...
                                        editor.jqxDropDownList(
                                            {
                                                source: listdataAdapter.records, displayMember: "id", valueMember: "leadid",promptText:"No Leads",renderer: function (index, label, value) 
                                                    ...
                                                    var option = '<option value="'+value+'"> <a href="'+hrefUrl+'" target="_blank" style="color:red;">'+value+'</a></option>';
                                                           return option;
                               ...
                               resultsEditor: function(row, cellvalue, editor){
                                  ...
                                  switch(data.result_type){
                                     ...
                                     case 'Select':
                                            ...
                                            alert("cust_grp resultsEditor "+cust_grp);
                                            alert("cust_grp resultsEditor "+prod_grp);
                                            var list = {
                                                datatype: "json",
                                                datafields:
                                                        [
                                                            ...
                                                            columns: [
                                                                ...
                                                                {text: 'Lead id', datafield: 'leadid', displayfield: 'leadid', width: 100, cellsalign: 'center', cellbeginedit: function (row, datafield, columntype) {
                                                                                   ...
                                                                                   // alert("leadid in quantity cell rendering "+leadid);
                                                                                    ...
                                                                                    {
                                                                                        //return true;
                                                                                        alert("custgroup in cellbeginedit"+cust_grp);
                                                                                        alert("itemgroup in cellbeginedit"+prod_grp);
                                                                                            var url = "dailyactivity/get_potentialquantity/" + escape(cust_grp) + "/" + escape(prod_grp);
                                                                                                $.ajax({
                                                                                                    ...
                                                                                                    success: function (result) {
                                                                                                      ...
                                                                                                      //  alert("columntype inside ajax "+this.columntype);
                                                                                                        if(noofleads>0)
                                                                                                        {
                                                                                                         this.columntype = 'dropdownlist';   
                                                                                                        }
                                                                                                      ...
                                                                                                      //  alert("columntype inside ajax after set "+this.columntype);
                                                                                    ...
                                                                                    alert("update createeditor");
                                                                                    alert("g_noofleads in update createeditor "+g_noofleads);
                                                                                    if(g_noofleads==0){
                                                                                     ...
                                                                                     else if (g_noofleads>0)
                                                                                     {
                                                                                            ...
                                                                                            listdataAdapter = new $.jqx.dataAdapter(list, {
                                                                                                autoBind: true,
                                                                                                async: false,
                                                                                                /*processData: function (suboptions) {
                                                                                                    var data = new Array();
                                                                                                    $.each(suboptions, function (id, value)
                                                                                                    {
                                                                                                        var list = records[i];
                        ...
                        $("#jqxgrid_add").jqxGrid(
                                {
                                    ...
                                    columns: [
                                        ...
                                        */
                                        ...
                                        {text: 'Mode of Contact', datafield: 'Mode_Of_Contact', width: 100, cellsalign: 'left', cellbeginedit:Results.initResultsEditorcon, createeditor: Results.resultsEditorcon, cellsrenderer: Results.renderUnitsst
                                        },
