                                                ...
                                                $("#jqxgrid_n").jqxGrid(
                                                        {
                                                            ...
                                                            columns: [
                                                               ...
                                                               /* {text: 'Lead id', datafield: 'leadid', displayfield: 'leadid', width: 100, cellsalign: 'center', cellbeginedit: Resultsupdate.initResultsEditor, createeditor: Resultsupdate.resultsEditor, cellsrenderer: Resultsupdate.renderUnits,cellvaluechanging: function (row, datafield, columntype, oldvalue, newvalue) 
                                                                ...
                                                                {text: 'Lead id', datafield: 'leadid', displayfield: 'leadid', width: 100, cellsalign: 'center', 
                        ...
                        $("#jqxgrid_add").jqxGrid(
                                {
                                    ...
                                    columns: [
                                        ...
                                        {text: 'Product Group', datafield: 'itemgroup', width: 150, cellsalign: 'left', editable: false},   
                                        {text: 'Lead id', datafield: 'leadid', displayfield: 'leadid', width: 100, cellsalign: 'center', cellbeginedit:Results.initResultsEditor, initeditor: Results.resultsEditor, cellsrenderer: Results.renderUnits,/*cellendedit:function (row, datafield, columntype) {
