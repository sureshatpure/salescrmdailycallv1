        ...
        var setfiltersexport = function (datafield, from_date, to_date) {
            ...
            if (sel_datefilter == true)
            {
                ...
                /*$.ajax({
                 ...
                 $.ajax({        
                   type: "POST",
                   url: baseurl + 'excelreportbranch/loginbranchesdates/',
...
//End function for exportexcel filter
        ...
        $("#excelExport").click(function () {
           $("#jqxgrid").jqxGrid('exportdata', 'xls', 'loginlogoutdata');
          //   dashboard/savefile');
        });
        var source =
                {
